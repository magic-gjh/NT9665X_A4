...
SHOW_ITEM_GROUP(CMD_Group,Skin91,0,0,49,49)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon92, 0, 0, 49,49, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal90)
SHOW_MAP_BODY(Skin91)
SHOW_MAP_BODY(Icon92)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal90,270,420,319,469)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovPlay,0,270,420,319,469)
...
SHOW_ITEM_GROUP(CMD_Group,Skin96,0,0,49,49)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon97, 0, 0, 49,49, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal95)
SHOW_MAP_BODY(Skin96)
SHOW_MAP_BODY(Icon97)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal95,170,420,219,469)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,170,420,219,469)
...
SHOW_ITEM_GROUP(CMD_Group,Skin100,0,0,49,49)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon101, 0, 0, 49,49, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal99)
SHOW_MAP_BODY(Skin100)
SHOW_MAP_BODY(Icon101)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal99,380,420,429,469)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,380,420,429,469)
...
SHOW_ITEM_GROUP(CMD_Group,Skin109,0,0,49,49)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon110, 0, 0, 49,49, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal108)
SHOW_MAP_BODY(Skin109)
SHOW_MAP_BODY(Icon110)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal108,480,420,529,469)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,480,420,529,469)
...
SHOW_ITEM_GROUP(CMD_Group,Normal112,131,386,242,413)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volumn,0,131,386,242,413)
