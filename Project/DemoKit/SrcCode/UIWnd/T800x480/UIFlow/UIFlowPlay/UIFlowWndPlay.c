...
INT32 UIFlowWndPlay_OnTouchKey(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_TOUCHPANEL_KEY,UIFlowWndPlay_OnTouchKey)
...
INT32 UIFlowWndPlay_OnTouchKey(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 P1,P2;
    ...
    if(TPIsOnRange(&UIFlowWndPlay_StatusICN_MovPlayCtrl,P1,P2)==TRUE)
    	{
    	     	Ux_PostEvent(NVTEVT_KEY_SHUTTER2, 1, NVTEVT_KEY_PRESS);				
	}
    if(TPIsOnRange(&UIFlowWndPlay_StatusICN_MovStopCtrl,P1,P2)==TRUE)
    	{
    	     	Ux_PostEvent(NVTEVT_KEY_PLAYBACK, 1, NVTEVT_KEY_PRESS);				
	}
    if(TPIsOnRange(&UIFlowWndPlay_StatusICN_MovBwdCtrl,P1,P2)==TRUE)
    	{
    	     	Ux_PostEvent(NVTEVT_KEY_LEFT, 1, NVTEVT_KEY_PRESS);				
	}	
    if(TPIsOnRange(&UIFlowWndPlay_StatusICN_MovFwdCtrl,P1,P2)==TRUE)
    	{
    	     	Ux_PostEvent(NVTEVT_KEY_RIGHT, 1, NVTEVT_KEY_PRESS);				
	}	
    if(TPIsOnRange(&UIFlowWndPlay_StaticICN_DSCModeCtrl,P1,P2)==TRUE)
    	{
