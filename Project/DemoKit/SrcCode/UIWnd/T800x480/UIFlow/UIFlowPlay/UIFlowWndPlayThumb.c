...
EVENT_ITEM(NVTEVT_KEY_UP,UIFlowWndPlayThumb_OnKeyLeft)//UIFlowWndPlayThumb_OnKeyUp)
EVENT_ITEM(NVTEVT_KEY_DOWN,UIFlowWndPlayThumb_OnKeyRight)//UIFlowWndPlayThumb_OnKeyDown)
...
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIFlowWndPlayThumb_OnKeyEnter)//UIFlowWndPlayThumb_OnKeyShutter2)
EVENT_END
