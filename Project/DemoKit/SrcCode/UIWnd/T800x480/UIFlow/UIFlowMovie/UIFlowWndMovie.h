...
typedef enum
{
UIFlowWndMovie_Status_Main_PB_ICON_MAIN_PB,
UIFlowWndMovie_Status_Main_PB_ICON_MAIN_PB_PRESSED,
UIFlowWndMovie_Status_Main_PB_MAX
}UIFlowWndMovie_Status_Main_PB_Setting;

extern VControl UIFlowWndMovie_Status_Main_MenuCtrl;//Status type 

typedef enum
{
UIFlowWndMovie_Status_Main_Menu_ICON_MAIN_MENU,
UIFlowWndMovie_Status_Main_Menu_ICON_MAIN_MENU_PRESSED,
UIFlowWndMovie_Status_Main_Menu_MAX
}UIFlowWndMovie_Status_Main_Menu_Setting;
