...
extern BOOL TPIsOnRangeMenu(VControl *pCtrl,UINT32 P1,UINT32 P2);
extern BOOL TPIsOnRange(VControl *pCtrl,UINT32 P1,UINT32 P2);
extern BOOL TPIsOnRangeList(VControl *pCtrl,UINT32 P1,UINT32 P2);
extern UINT32 TP_PhaseListItem_Index(VControl *pCtrl,UINT32 Y);
