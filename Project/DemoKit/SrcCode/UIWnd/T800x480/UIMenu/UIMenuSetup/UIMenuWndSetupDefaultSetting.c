...
INT32 UIMenuWndSetupDefaultSetting_OnKeyReverseGear(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_REVERSEGEAR,UIMenuWndSetupDefaultSetting_OnKeyReverseGear)
...
INT32 UIMenuWndSetupDefaultSetting_OnKeyReverseGear(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    Ux_CloseWindow(&MenuCommonItemCtrl,0); // close whole tab menu
    return NVTEVT_CONSUME;
}
