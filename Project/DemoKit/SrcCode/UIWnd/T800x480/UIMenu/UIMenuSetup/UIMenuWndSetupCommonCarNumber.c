...
INT32 UIMenuWndSetupCommonCarNumber_OnReverseGear(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_MENU,UIMenuWndSetupCommonCarNumber_OnKeyShutter2)
#else
...
EVENT_ITEM(NVTEVT_REVERSEGEAR,UIMenuWndSetupCommonCarNumber_OnReverseGear)
...
INT32 UIMenuWndSetupCommonCarNumber_OnReverseGear(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndSetupCommonCarNumber_Tab_OnKeyMenu)
#else
