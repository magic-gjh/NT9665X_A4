...
INT32 UIMenuWndSetupFormatConfirm_OnReverseGear(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_REVERSEGEAR,UIMenuWndSetupFormatConfirm_OnReverseGear)
...
INT32 UIMenuWndSetupFormatConfirm_OnReverseGear(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    Ux_CloseWindow(&MenuCommonItemCtrl,0); // close whole tab menu
    return NVTEVT_CONSUME;
}
...
INT32 UIMenuWndSetupFormatConfirm_List_Text_OnTouchPanelKey(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndSetupFormatConfirm_List_Text_OnTimer(VControl *, UINT32, UINT32 *);
...
#endif
EVENT_ITEM(NVTEVT_TOUCHPANEL_KEY,UIMenuWndSetupFormatConfirm_List_Text_OnTouchPanelKey)
EVENT_ITEM(NVTEVT_TIMER,UIMenuWndSetupFormatConfirm_List_Text_OnTimer)
EVENT_END
...
INT32 UIMenuWndSetupFormatConfirm_List_Text_OnTouchPanelKey(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 P1,P2;
...
INT32 UIMenuWndSetupFormatConfirm_List_Text_OnTimer(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    NVTEVT event;
    TM_MENU*    pMenu = TM_GetMenu();
