...
enum _MENU_IDS
{
    ...
    // LED Setting  Options
    IDS_LEDSET_OFF   = STRID_OFF,//STRID_IRLED_OFF,
    IDS_LEDSET_ON    = STRID_ON,//STRID_IRLED_ON,
    IDS_LEDSET_WARNING    = STRID_IRLED_WARNING,

    // LCD Setting  Options
    IDS_LCDOFF_OFF          = STRID_OFF,
    IDS_LCDOFF_30SEC        = STRID_AUTO_OFF_3MIN,
    IDS_LCDOFF_1MIN         = STRID_AUTO_OFF_5MIN,
    IDS_LCDOFF_2MIN         = STRID_AUTO_OFF_10MIN,
