...
SHOW_ITEM_GROUP(CMD_Group,Normal29,365,32,472,59)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Size,0,365,32,472,59)
...
SHOW_ITEM_GROUP(CMD_Group,Normal42,444,65,471,92)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Quality,0,444,65,471,92)
...
SHOW_ITEM_GROUP(CMD_Group,Normal48,445,97,472,124)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Sharpness,0,445,97,472,124)
...
SHOW_ITEM_GROUP(CMD_Group,Normal54,445,204,472,231)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Storage,0,445,204,472,231)
...
SHOW_ITEM_GROUP(CMD_Group,Normal59,441,237,472,264)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Battery,0,441,237,472,264)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin71Rect,0,0,199,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin71)
SHOW_MAP_BODY(Skin71Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin71,0,0,199,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text73,0,0,199,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal70)
SHOW_MAP_BODY(Skin71)
SHOW_MAP_BODY(Text73)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal70,273,5,472,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Filename,0,273,5,472,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal79,326,210,433,237)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Date,0,326,210,433,237)
...
SHOW_ITEM_GROUP(CMD_Group,Normal84,326,232,433,259)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Time,0,326,232,433,259)
...
CREATE_TAB_CTRL(UIFlowWndPlay_Histo,UIFlowWndPlay_Histo,0,308,158,435,207)
...
SHOW_ITEM_GROUP(CMD_Group,Normal90,12,237,65,264)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovPlay,0,12,237,65,264)
...
SHOW_ITEM_GROUP(CMD_Group,Normal95,71,237,124,264)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,71,237,124,264)
...
SHOW_ITEM_GROUP(CMD_Group,Normal99,130,237,183,264)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,130,237,183,264)
...
SHOW_ITEM_GROUP(CMD_Group,Normal103,84,5,165,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,84,5,165,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal108,189,237,242,264)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,189,237,242,264)
...
SHOW_ITEM_GROUP(CMD_Group,Normal112,96,201,207,228)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volumn,0,96,201,207,228)
...
SHOW_ITEM_GROUP(CMD_Group,Normal128,15,201,74,228)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Speed,0,15,201,74,228)
...
SHOW_ITEM_GROUP(CMD_Group,Normal133,84,5,165,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovTotalTime,0,84,5,165,32)
...
CREATE_CTRL(UIFlowWndPlay,UIFlowWndPlay,CTRL_WND,NULL,0 ,0,0,479,271)
#endif
