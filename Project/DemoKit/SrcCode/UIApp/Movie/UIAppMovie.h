...
#include "../../UIWnd/D800x480/UIInfo/UIMovieInfo.h"
#elif(UI_RESOLUTION==UI_RESOLUTION_D480x272)
#include "../../UIWnd/D480x272/UIInfo/UIMovieInfo.h"
#elif(UI_RESOLUTION==UI_RESOLUTION_TOUCH_800x480)
#include "../../UIWnd/T800x480/UIInfo/UIMovieInfo.h"
#else
#include "../../UIWnd/DRIVER/UIInfo/UIMovieInfo.h"
#endif
...
typedef enum
{
    ...
    NVTEVT_EXE_SET_MOV_SENOB   //#NT2014/03/28# Sun chen for AR0330 high temperature issue
}CUSTOM_MOVIE_EVENT;
