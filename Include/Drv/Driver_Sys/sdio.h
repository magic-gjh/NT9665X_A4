...
typedef enum
{
    ...
    SDIO_CONFIG_ID_SRCLK,                   ///< Set source clock for SDIO host
                                            ///< Context can be any of:
                                            ///< - @b SDIO_SRC_CLK_40MHZ (only SDIO2 support)
                                            ///< - @b SDIO_SRC_CLK_48MHZ (Defalut value)
                                            ///< - @b SDIO_SRC_CLK_80MHZ (only SDIO support)
                                            ///< - @b SDIO_SRC_CLK_96MHZ (only SDIO support)
                                            ///< - @b SDIO_SRC_CLK_PLL4
...
/**
    ...
    @note for sdio_getMiscInfo(), sdio2_getMiscInfo().
*/
typedef struct
{
