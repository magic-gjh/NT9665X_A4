...
*/
//@{
#define FILEDB_SUPPORT_FILE_TYPE_NUM          10                ///< Total FileDB support file type number
...
#define FILEDB_FMT_ANY                        0x03FF            ///< any file format, the ORed of all supported file type
//@}
...
/**
    ...
    @code
    {
        ...
        pBuf = dma_getCacheAddr(SxCmd_GetTempMem(MemSize));
