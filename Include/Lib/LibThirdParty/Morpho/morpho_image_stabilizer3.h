...
/** Version string */
# define MORPHO_IMAGE_STABILIZER3_VERSION "Morpho PhotoSolid Ver.3.1.0 2012/09/19" " (release-4.0 " __DATE__ " " __TIME__ ")"

/** Version specified */
# define MORPHO_IMAGE_STABILIZER_VERSION_3_1

/** Use hardware I/F */
/* # define MORPHO_IMAGE_STABILIZER3_USE_HW_IF */

/** Use image data pitch */
# define MORPHO_USE_IMAGE_DATA_PITCH
...
/*
MORPHO_API(int)
morpho_ImageStabilizer3_getAccumBlockSizeAndNum(
    morpho_ImageStabilizer3 *stabilizer,
    int *blockSize,
    int *blockNumX,
    int *blockNumY
...
MORPHO_API(int)
morpho_ImageStabilizer3_outputAccumMap(
    morpho_ImageStabilizer3 *stabilizer,
    unsigned char *p_dst
    );
*/
