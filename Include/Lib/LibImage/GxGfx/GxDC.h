...
#define PXLFMT_P1               0x00    ///< state = 1 color plane
#define PXLFMT_P1_PK            0x10    ///< state = 1 color plane (888 packed)
#define PXLFMT_P1_IDX           0x20    ///< state = 1 color plane, index
#define PXLFMT_P3               0x30    ///< state = 3 color plane x 3
#define PXLFMT_P1_PK2           0x40    ///< state = 3 color plane (565 packed)
#define PXLFMT_YUV              0x08    ///< state = YUV, not RGB
#define PXLFMT_YUV_PK           0x04    ///< state = YUV_PK
...
#define PXLFMT_INDEX1           (PXLFMT_P1_IDX | 0x00)  ///< state = 1 color plane, pixel=INDEX2
...
#define PXLFMT_RGB888           (PXLFMT_P3 | 0x00)      ///< state = 3 color plane, pixel=R8, G8, and B8
#define PXLFMT_RGB565           (PXLFMT_P3 | 0x01)      ///< state = 3 color plane, pixel=R8, G8, and B8
#define PXLFMT_RGB555           (PXLFMT_P3 | 0x02)      ///< state = 3 color plane, pixel=R8, G8, and B8
#define PXLFMT_YUV422_PK        (PXLFMT_P3 | 0x05)      ///< state = 3 color plane, pixel=Y(w,h), U(w/2,h), and V(w/2,h)
#define PXLFMT_YUV420_PK        (PXLFMT_P3 | 0x06)      ///< state = 3 color plane, pixel=Y(w,h), U(w/2,h/2), and V(w/2,h/2)
#define PXLFMT_YUV421_PK        (PXLFMT_P3 | 0x07)      ///< state = 3 color plane, pixel=Y(w,h), U(w,h/2), and V(w,h/2)
#define PXLFMT_YUV444           (PXLFMT_P3 | 0x08)      ///< state = 3 color plane, pixel=Y(w,h), U(w,h), and V(w,h)
#define PXLFMT_YUV422           (PXLFMT_P3 | 0x09)      ///< state = 3 color plane, pixel=Y(w,h), U(w/2,h), and V(w/2,h)
#define PXLFMT_YUV420           (PXLFMT_P3 | 0x0A)      ///< state = 3 color plane, pixel=Y(w,h), U(w/2,h/2), and V(w/2,h/2)
#define PXLFMT_YUV421           (PXLFMT_P3 | 0x0B)      ///< state = 3 color plane, pixel=Y(w,h), U(w,h/2), and V(w,h/2)
