...
typedef enum _GX_IMAGE_PIXEL_FMT_
{
    ...
    GX_IMAGE_PIXEL_FMT_ARGB888_PACKED = 0x07,    ///< 1 color plane, pixel=ARGB(4w,h)
...
typedef enum _GX_IMAGE_RT_ENG
{
    ...
    GX_IMAGE_ROTATE_ENG2,          ///< Rotation Engine 2
...
{
    GX_IMAGE_ROTATE_90 = 0,  ///< rotate 90 degree
    GX_IMAGE_ROTATE_270,     ///< rotate 270 degree
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER GxImg_CopyColorkeyData(PIMG_BUF pSrcImg, IRECT* pCopyRegion, PIMG_BUF pKeyImg, IPOINT* pKeyLocation, UINT32 colorkey, BOOL isCopyToKeyImg);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER GxImg_CopyBlendingData(PIMG_BUF pSrcImg, IRECT* pSrcRegion, PIMG_BUF pDstImg, IPOINT* pDstLocation, UINT32 alpha);
...
/**
     ...
     This API will scale up/down image data, the max scale up/down factor is 8.\n
     This API have no start address word alignment limitation or width/height word alignment limitation.\n
     The scaling method just have GXIMG_SCALE_BILINEAR or GXIMG_SCALE_NEAREST for choosing.
