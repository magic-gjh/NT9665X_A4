...
{
    GXCUSTOM_CTRL_AUTOLCDOFF_TIME = 0,          ///<  auto lcd off system time value set, get
    GXCUSTOM_CTRL_AUTOLCDOFF_EN,                ///<  system lcd auto power off enable, disable
...
extern UINT32  GxCustom_GetControl(GXCUSTOM_CTRL CustomCtrl);
extern void GxCustom_SetControl(GXCUSTOM_CTRL CustomCtrl, UINT32 value);
//@}
#endif //_GXPOWER_H
