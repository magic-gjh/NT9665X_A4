...
/**
  ...
  Detect that the IR keys are pressed from Car Touch Panel.
  @note This API should be registered to SxTimer.
*/
extern UINT32   GxKey_DetIrKey(void);
...
typedef enum _TP_GESTURE_CODE
{
    ...
    TP_GESTURE_RELEASE       = 0x00000004,   ///< touch release
    TP_GESTURE_CLICK         = 0x00000008,   ///< touch click
    TP_GESTURE_DOUBLE_CLICK  = 0x00000010,   ///< touch double click
    TP_GESTURE_SLIDE_LEFT    = 0x00000020,   ///< touch slide left
    TP_GESTURE_SLIDE_RIGHT   = 0x00000040,   ///< touch slide right
    TP_GESTURE_SLIDE_UP      = 0x00000080,   ///< touch slide up
    TP_GESTURE_SLIDE_DOWN    = 0x00000100,   ///< touch slide down
