...
//extern UINT32 gDevLCDObj; //TODO: this is project level variable, remove
//extern UINT32 gDevTVObj; //TODO: this is project level variable, remove
//extern UINT32 gDevHDMIObj; //TODO: this is project level variable, remove
...
/**
     Set current device size of current mode.
     ...
     @param[in] DevID           Device id (ex: DOUT1 or DOUT2). 
*/
extern void GxVideo_SetDeviceSize(UINT32 DevID, ISIZE *pSetSize);
...
/**
     ...
     @return                    Device size
*/
extern ISIZE GxVideo_QueryDeviceModeSize(UINT32 NewDevObj, UINT32 mode);
...
#define DISPLAY_FOCRCE_DET_AGAIN      1  // Only scan once
#define DISPLAY_FOCRCE_DET_EXISTED    2  // Do not detect again

/**
    Force to trigger TV/HDMI connecting event.

    @param[in]Set param1 for forcing TV/HDMI detecting or not again.
*/
extern void GxVideo_ForceConnect(UINT32 param1, UINT32 context);
...
/**
     ...
     @note Nothing
*/
extern void GxVideo_InstallCmd(void);
