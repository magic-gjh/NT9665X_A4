...
/**
    ...
    LviewNvt_VideoTsk needed information.
*/
//@{
...
typedef UINT32 (*LVIEWNVT_FRAMECB)(UINT32 frameIdx, MEM_RANGE* frameBuf);
typedef UINT32 (*LVIEWNVT_AUDIOCB)(UINT32 audioIdx, MEM_RANGE* audioBuf);
//@}
