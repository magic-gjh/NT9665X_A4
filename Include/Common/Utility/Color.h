...
#define COLOR_RGB_DARKRED           0x00000080 ///< built-in color
#define COLOR_RGB_DARKGREEN         0x00008000 ///< built-in color
#define COLOR_RGB_DARKYELLOW        0x00008080 ///< built-in color
#define COLOR_RGB_DARKBLUE          0x00800000 ///< built-in color
#define COLOR_RGB_DARKMAGENTA       0x00800080 ///< built-in color
#define COLOR_RGB_DARKCYAN          0x00808000 ///< built-in color
#define COLOR_RGB_LIGHTGRAY         0x00C0C0C0 ///< built-in color
#define COLOR_RGB_GRAY              0x00808080 ///< built-in color
#define COLOR_RGB_RED               0x000000FF ///< built-in color
#define COLOR_RGB_GREEN             0x0000FF00 ///< built-in color
#define COLOR_RGB_YELLOW            0x0000FFFF ///< built-in color
#define COLOR_RGB_BLUE              0x00FF0000 ///< built-in color
#define COLOR_RGB_MAGENTA           0x00FF00FF ///< built-in color
#define COLOR_RGB_CYAN              0x00FFFF00 ///< built-in color
#define COLOR_RGB_WHITE             0x00FFFFFF ///< built-in color
#define COLOR_RGB_PASTELGREEN       0x00C0DCC0 ///< built-in color
#define COLOR_RGB_PASTELBLUE        0x00F0CAA6 ///< built-in color
#define COLOR_RGB_SOFTWHITE         0x00F0FBFF ///< built-in color
#define COLOR_RGB_MEDIUMGRAY        0x00A4A0A0 ///< built-in color
//@}
...
#define COLOR_YUV_DARKRED           0x0076C00F ///< built-in color
#define COLOR_YUV_DARKGREEN         0x004A564B ///< built-in color
#define COLOR_YUV_DARKYELLOW        0x0040965A ///< built-in color
#define COLOR_YUV_DARKBLUE          0x00C06A26 ///< built-in color
#define COLOR_YUV_DARKMAGENTA       0x00B6AA35 ///< built-in color
#define COLOR_YUV_DARKCYAN          0x008A4071 ///< built-in color
#define COLOR_YUV_LIGHTGRAY         0x008080C0 ///< built-in color
#define COLOR_YUV_GRAY              0x00808080 ///< built-in color
#define COLOR_YUV_RED               0x006BFF1D ///< built-in color
#define COLOR_YUV_GREEN             0x00152C96 ///< built-in color
#define COLOR_YUV_YELLOW            0x0001ABB3 ///< built-in color
#define COLOR_YUV_BLUE              0x00FF554C ///< built-in color
#define COLOR_YUV_MAGENTA           0x00EBD469 ///< built-in color
#define COLOR_YUV_CYAN              0x009500E2 ///< built-in color
...
#define COLOR_RGBD_GET_B(c)         (CVALUE)(((c) & 0x00ff0000) >> 16) ///< get B channel value of RGBD color
#define COLOR_RGBD_GET_G(c)         (CVALUE)(((c) & 0x0000ff00) >> 8) ///< get G channel value of RGBD color
#define COLOR_RGBD_GET_R(c)         (CVALUE)(((c) & 0x000000ff) >> 0) ///< get R channel value of RGBD color

#define COLOR_RGBA_GET_A(c)         (CVALUE)(((c) & 0xff000000) >> 24) ///< get A channel value of RGBA color
#define COLOR_RGBA_GET_B(c)         (CVALUE)(((c) & 0x00ff0000) >> 16) ///< get B channel value of RGBA color
#define COLOR_RGBA_GET_G(c)         (CVALUE)(((c) & 0x0000ff00) >> 8) ///< get G channel value of RGBA color
#define COLOR_RGBA_GET_R(c)         (CVALUE)(((c) & 0x000000ff) >> 0) ///< get R channel value of RGBA color
...
#define COLOR_MAKE_RGBD(r,g,b)      \
                                    (((COLOR_ITEM)(r)&0x000000ff)|\
                                    (((COLOR_ITEM)(g)&0x000000ff)<<8)|\
                                    (((COLOR_ITEM)(b)&0x000000ff)<<16)) ///< make RGBD color by R,G,B channel value
