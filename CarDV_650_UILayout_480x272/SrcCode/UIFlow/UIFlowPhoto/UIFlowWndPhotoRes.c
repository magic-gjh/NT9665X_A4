...
SHOW_ITEM_GROUP(CMD_Group,Normal13,365,5,472,32)
...
CREATE_STATIC_CTRL(UIFlowWndPhoto_StaticTXT_FreePic,0,365,5,472,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal41,365,38,472,65)
...
CREATE_STATIC_CTRL(UIFlowWndPhoto_StaticTXT_Size,0,365,38,472,65)
...
SHOW_ITEM_GROUP(CMD_Group,Normal59,445,104,472,131)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_FD,0,445,104,472,131)
...
SHOW_ITEM_GROUP(CMD_Group,Normal65,445,71,472,98)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Quality,0,445,71,472,98)
...
SHOW_ITEM_GROUP(CMD_Group,Normal71,445,204,472,231)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Storage,0,445,204,472,231)
...
SHOW_ITEM_GROUP(CMD_Group,Normal77,12,237,71,264)
...
CREATE_STATIC_CTRL(UIFlowWndPhoto_StaticTXT_DZoom,0,12,237,71,264)
...
SHOW_ITEM_GROUP(CMD_Group,Normal82,441,237,472,264)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Battery,0,441,237,472,264)
...
CREATE_CTRL(UIFlowWndPhoto_PNL_Histogram,UIFlowWndPhoto_PNL_Histogram,CTRL_WND,NULL,0 ,240,213,367,262)
SHOW_MAP_BEGIN(Skin98)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin98,0,0,479,271)
...
CREATE_CTRL(UIFlowWndPhoto_PNL_FDFrame,UIFlowWndPhoto_PNL_FDFrame,CTRL_WND,NULL,0 ,0,0,479,271)
...
CREATE_CTRL(UIFlowWndPhoto,UIFlowWndPhoto,CTRL_WND,NULL,0 ,0,0,479,271)
#endif
