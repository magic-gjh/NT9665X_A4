...
SHOW_ITEM_RECT(CMD_Rectangle,Rect3,56,50,455,208,16,2,0,1,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal4,148,126,363,163)
...
SHOW_ITEM_GROUP(CMD_Group,Focused8,148,126,363,163)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable19,148,126,363,163)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable23,148,126,363,163)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed27,148,126,363,163)
...
CREATE_LIST_CTRL(UIMenuWndSetupFormatConfirm_List_Text,UIMenuWndSetupFormatConfirm_List_Text,0,148,126,363,163)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(Skin34)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin34,0,0,215,54)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text36,0,0,215,54,STRID_NULL,0,0,0,0,2,1,1,256,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal33)
SHOW_MAP_BODY(Skin34)
SHOW_MAP_BODY(Text36)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal33,148,63,363,117)
...
CREATE_STATIC_CTRL(UIMenuWndSetupFormatConfirm_Static_Text,0,148,63,363,117)
...
CREATE_CTRL(UIMenuWndSetupFormatConfirm,UIMenuWndSetupFormatConfirm,CTRL_WND,NULL,0 ,0,0,479,271)
#endif
