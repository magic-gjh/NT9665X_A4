...
extern BOOL GSensor_DRAMD07_open(void);
extern BOOL GSensor_DRAMD07_close(void);
extern BOOL GSensor_DRAMD07_GetStatus(Gsensor_Data *GS_Data);
extern BOOL GSensor_DRAMD07_ParkingMode(void);
extern BOOL GSensor_DRAMD07_CrashMode(void);
extern void GSensor_DRAMD07_SetSensitivity(GSENSOR_SENSITIVITY GSensorSensitivity);
extern void GSensor_DRAMD07_ClearCrashMode(void);
extern void GSensor_DRAMD07_SetInterrupt(BOOL En);
