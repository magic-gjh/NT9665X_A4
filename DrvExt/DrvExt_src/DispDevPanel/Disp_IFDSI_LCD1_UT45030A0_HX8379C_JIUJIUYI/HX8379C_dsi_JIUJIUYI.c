...
#define PANEL_TYPE_VERSION03  0X03//ÁúÔÆË¼×³×ÔÅäLCD ,¾Å¾ÅÒ»

#define PANEL_TYPE  PANEL_TYPE_VERSION03//PANEL_TYPE_VERSION01//
...
const tPANEL_CMD tCmdModeDSI[] =
{
...
#elif(PANEL_TYPE == PANEL_TYPE_VERSION03)  //version 3
	{DSICMD_CMD,0xB9},      
	{DSICMD_DATA,  0xFF},
	{DSICMD_DATA,  0x83},
	{DSICMD_DATA,  0x79},
	...
	{DSICMD_DATA, 0x86},
	{DSICMD_DATA, 0x23},
	{DSICMD_DATA, 0x86},  //set cyc                   

	{DSICMD_CMD,0xC7},
	{DSICMD_DATA, 0x00},
	{DSICMD_DATA, 0x00},
	{DSICMD_DATA, 0x00},
	{DSICMD_DATA, 0xC0},  //set tcon                                                 

	{DSICMD_CMD,0xCC},
	{DSICMD_DATA,0x02},  //set panel                                                               

	{DSICMD_CMD,0xD2},
	{DSICMD_DATA, 0x33},  //set offset                                                              
	...
	{DSICMD_DATA, 0x13},
	{DSICMD_DATA, 0x13},
	{DSICMD_DATA, 0x17},	//set gamma       

	{DSICMD_CMD,0xB6},
	{DSICMD_DATA, 0x68},
	{DSICMD_DATA, 0x68},  //set vcom  4d                                                         
