...
const tPANEL_CMD tCmdModeRgb320[] =
{
    ...
    {0x72, 0x6300},  //Second Transmission (Data     0x6300)

    {0x70, 0x0002},  //First  Transmission (Register 0x02)
    {0x72, 0x0200},  //Second Transmission (Data     0x0200)

    {0x70, 0x0003},  //First  Transmission (Register 0x03)
    {0x72, 0x7164},  //Second Transmission (Data     0x7164)

    {0x70, 0x0004},  //First  Transmission (Register 0x04)
    {0x72, 0x044f},  //Second Transmission (Data     0x044f, Serial-RGB format)

    {0x70, 0x0005},  //First  Transmission (Register 0x05)
    {0x72, 0xb4d4},  //Second Transmission (Data     0xb4d4)

    {0x70, 0x000a},  //First  Transmission (Register 0x0a)
    {0x72, 0x4008},  //Second Transmission (Data     0x4008)

    {0x70, 0x000b},  //First  Transmission (Register 0x0b)
    {0x72, 0xd400},  //Second Transmission (Data     0xd400)

    {0x70, 0x000d},  //First  Transmission (Register 0x0d)
    {0x72, 0x123a},  //Second Transmission (Data     0x123a)

    {0x70, 0x000e},  //First  Transmission (Register 0x0e)
    {0x72, 0x2c00},  //Second Transmission (Data     0x2c00)

    {0x70, 0x000f},  //First  Transmission (Register 0x0f)
    {0x72, 0x0000},  //Second Transmission (Data     0x0000)

    {0x70, 0x0016},  //First  Transmission (Register 0x16)
    {0x72, 0x9f80},  //Second Transmission (Data     0x9f80)

    {0x70, 0x0017},  //First  Transmission (Register 0x17)
    {0x72, 0x2212},  //Second Transmission (Data     0x2212)

    {0x70, 0x001e},  //First  Transmission (Register 0x1e)
    {0x72, 0x00cb},  //Second Transmission (Data     0x00cb)

    {0x70, 0x0030},  //First  Transmission (Register 0x30)
    {0x72, 0x0507},  //Second Transmission (Data     0x0507)

    {0x70, 0x0031},  //First  Transmission (Register 0x31)
    {0x72, 0x0004},  //Second Transmission (Data     0x0004)

    {0x70, 0x0032},  //First  Transmission (Register 0x32)
    {0x72, 0x0707},  //Second Transmission (Data     0x0707)
