...
static BOOL dispdev_chgHdmiClkFreq(BOOL bNative)
{
    ...
    */
    ...
    // Set DC109 HDMI CTS Pass parameters as default settings when pix-clk below 74.25MHz
    hdmitx_setConfig(HDMI_CONFIG_ID_SWING_CTRL,     HDMI_SWING_CTRL_N09);
    hdmitx_setConfig(HDMI_CONFIG_ID_BGR_CTRL,       0x1);
    ...
    case HDMI_720X480P240_16X9:     /* VID57 */
    {
        ...
        // Use DTE Default value for pix-clk larger than 74.25MHz
        hdmitx_setConfig(HDMI_CONFIG_ID_SWING_CTRL,     HDMI_SWING_CTRL_DEFAULT);
        hdmitx_setConfig(HDMI_CONFIG_ID_BGR_CTRL,       0x4);
    }
    break;
