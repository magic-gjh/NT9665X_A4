...
#define GPIO_12VDC_DET           (3 | GPIO_IS_DGPIO)///sensor2 TV single input IO 5v,car run back state
#define PAD_12VDC_DET            PAD_PIN_DGPIO3
//#define GPIO_DET_ACC               (1 | GPIO_IS_DGPIO)            // Key Menu (km)
//#define PAD_DET_ACC                PAD_PIN_DGPIO1
