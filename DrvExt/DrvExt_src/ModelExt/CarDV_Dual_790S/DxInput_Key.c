...
#define VOLDET_KEY_ADC_LVL2         (349-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (516-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (956-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (956+VOLDET_KEY_ADC_RANGE)
