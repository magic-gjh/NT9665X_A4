...
// V = ADC*4.2/910
#define VOLDET_BATTERY_410V         640//630//640
#define VOLDET_BATTERY_390V         605//590//600
#define VOLDET_BATTERY_370V         580//560//580
#define VOLDET_BATTERY_365V         575//560//580
//#define VOLDET_BATTERY_360V         760//735
...
static UINT32 DrvPower_GetBatteryADC(void)
{
 UINT32 uiADCValue;
    ...
    //debug_msg("DrvPower_GetBatteryADC:%d..\r\n",uiADCValue);
    return uiADCValue;
