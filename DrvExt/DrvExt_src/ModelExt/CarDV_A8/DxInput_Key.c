...
#define VOLDET_KEY_ADC_LVL3         (518-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (645-VOLDET_KEY_ADC_RANGE)
//#define VOLDET_KEY_ADC_LVL5         (756-VOLDET_KEY_ADC_RANGE)


#define VOLDET_KEY_ADC_TH            (650+VOLDET_KEY_ADC_RANGE)
