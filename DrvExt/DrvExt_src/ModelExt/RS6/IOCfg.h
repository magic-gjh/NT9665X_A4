...
#define GPIO_SENSOR_STANDBY         D_GPIO_6 // to fix compiling error

#define GPIO_GPS_PWR 	P_GPIO_44
#define PAD_GPS_PWR           PAD_PIN_PGPIO44
...
#define GPIO_KEY_SHUTTER2           P_GPIO_42           // Key Shutter2 (ks2)
