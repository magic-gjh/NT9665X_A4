...
#define VOLDET_KEY_ADC_LVL2         (354-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (512-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (640-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (640+VOLDET_KEY_ADC_RANGE)
...
#define VOLDET_KEY_LVL_CUSTOMER1         6
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    {   
        ...
        {
            uiCurKey1Lvl = VOLDET_KEY_LVL_MODE;
        } 		
...
UINT32 DrvKey_DetNormalKey(void)
{
    ...
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_CUSTOMER1)
    {
        uiKeyCode |= FLGKEY_CUSTOM1;
    }	
#endif
