...
void DrvSound_SetAudioFeature(void)
{
    ...
    #if 1 // Fine tune for audio background noise level 2013/04/30
    aud_setFeature(AUDIO_FEATURE_NG_WITH_MICBOOST,                                    FALSE);
    aud_setParameter(AUDIO_PARAMETER_NOISETHD_WITH_BOOST,         EAC_NG_THRESHOLD_N48P0_DB);
    aud_setParameter(AUDIO_PARAMETER_ALC_MAXGAIN,                   EAC_ALC_MAXGAIN_P7P5_DB);
    #else
