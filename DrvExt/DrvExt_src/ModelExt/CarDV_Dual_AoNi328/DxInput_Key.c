...
#define KEY_BOARD_TYPE   PW84_KEY_BOARD_MUBEN// PW84_KEY_BOARD_AIDUOSHI_6KEYS//
...
#define VOLDET_KEY_ADC_LVL1         (188-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (362-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (569-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (569+VOLDET_KEY_ADC_RANGE)
