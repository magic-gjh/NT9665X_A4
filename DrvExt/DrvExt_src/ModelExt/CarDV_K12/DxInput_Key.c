...
#define VOLDET_KEY_ADC_LVL2         (352-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (516-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (692-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (692+VOLDET_KEY_ADC_RANGE)
