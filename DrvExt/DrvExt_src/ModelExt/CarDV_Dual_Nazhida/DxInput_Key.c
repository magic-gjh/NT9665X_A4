...
#define VOLDET_KEY_ADC_TH           (348+VOLDET_KEY_ADC_RANGE)
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    {    
        ...
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_UNKNOWN;//VOLDET_KEY_LVL_UP;
		//debug_msg("KEY SHUTTER2..\r\n");			
        }
        else if (uiKey1ADC >= VOLDET_KEY_ADC_LVL1)
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_UNKNOWN;//VOLDET_KEY_LVL_DOWN;
		//debug_msg("KEY UP..\r\n");			
        }
