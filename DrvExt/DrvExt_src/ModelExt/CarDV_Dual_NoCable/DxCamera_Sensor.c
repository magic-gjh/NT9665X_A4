...
SENSOR_INIT_OBJ DrvSensor_GetObj1st(void)
{
    ...
    #if 0
    //sensor 2
    gpio_setPin(GPIO_141_33EN);
    gpio_setPin(GPIO_141_15EN);
    Delay_DelayMs(1);
    gpio_clearPin(GPIO_141_STB);
    Delay_DelayMs(10);
    gpio_clearPin(GPIO_141_RST);
    Delay_DelayMs(20);
    gpio_setPin(GPIO_141_RST);
    #endif
