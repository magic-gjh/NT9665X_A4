...
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_RANGE        (15)
#define VOLDET_KEY_ADC_LVL0         (0)
#define VOLDET_KEY_ADC_LVL1         (15-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (248-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (417-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (517-VOLDET_KEY_ADC_RANGE)

#define VOLDET_KEY_ADC_TH           (517+VOLDET_KEY_ADC_RANGE)
