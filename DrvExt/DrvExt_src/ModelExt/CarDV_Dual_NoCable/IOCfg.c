...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
    ...
    //Sensor 2
    {  GPIO_141_33EN,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
    {  GPIO_141_15EN,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
    {  GPIO_141_STB,            GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,    GPIO_SET_NONE       },
    {  GPIO_141_RST,            GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
#if 0
    //KEY
