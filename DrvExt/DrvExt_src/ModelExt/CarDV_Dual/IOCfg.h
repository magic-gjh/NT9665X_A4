...
#define IO_CONFIG_PRJ               IO_CONFIG_PRJ_M
...
#if (IO_CONFIG_PRJ == IO_CONFIG_PRJ_M)
#define GPIO_LCD_BLG_PCTL           C_GPIO_22
#define PAD_LCD_BLG_PCTL            PAD_PIN_CGPIO22
#define GPIO_LCD_RESET              P_GPIO_36 // PWM0, no use
#elif (IO_CONFIG_PRJ == IO_CONFIG_PRJ_P)
#define GPIO_LCD_BLG_PCTL           P_GPIO_9
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO9
#define GPIO_LCD_RESET              P_GPIO_36 // PWM0, no use
#else // IO_CONFIG_PRJ_J
#define GPIO_LCD_BLG_PCTL           P_GPIO_48
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO48
#define GPIO_LCD_RESET              P_GPIO_49
#endif
#endif
...
#define GPIO_TV_PLUG                P_GPIO_39
#define PAD_TV_PLUG                 PAD_PIN_PGPIO39
#endif
...
#define GPIO_913Q_PCTL              P_GPIO_40   // Power control for 913Q serializer, HIGH active
#define GPIO_914Q_EN                P_GPIO_39   // 1.8V power enable for 914Q deserializer, HIGH active
#define GPIO_914Q_PDB               D_GPIO_6    // Power down of 914Q deserializer, LOW active
#define GPIO_914Q_LOCK              S_GPIO_25   // 913Q/914Q LOCK status, HIGH: lock, LOW: unlock
#define GPIO_914Q_PASS              P_GPIO_56   // 913Q/914Q data transmission status, HIGH: pass, LOW: error
#define PAD_914Q_LOCK               PAD_PIN_SGPIO25
#define PAD_914Q_PASS               PAD_PIN_PGPIO56
