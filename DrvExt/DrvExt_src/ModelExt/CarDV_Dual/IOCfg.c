...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
    ...
    //LCD
    {  GPIO_LCD_BLG_PCTL,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,    GPIO_SET_NONE       },
    ...
    //Sensor
    {  GPIO_SENSOR_PWM0,        GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,    GPIO_SET_NONE       },
    {  GPIO_SENSOR_PWM1,        GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,    GPIO_SET_NONE       },
    {  GPIO_SENSOR_RESET,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
    //Serializer/Deserializer
    {  GPIO_913Q_PCTL,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       }, // turn on TI 913Q power
    {  GPIO_914Q_EN,            GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
    {  GPIO_914Q_PDB,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     GPIO_SET_NONE       },
    {  GPIO_914Q_LOCK,          GPIO_DIR_INPUT,     PAD_PULLDOWN,           PAD_914Q_LOCK       },
    {  GPIO_914Q_PASS,          GPIO_DIR_INPUT,     PAD_PULLDOWN,           PAD_914Q_PASS       },
#if 0
    //KEY
