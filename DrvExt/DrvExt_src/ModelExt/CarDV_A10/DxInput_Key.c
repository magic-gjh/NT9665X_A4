...
#define VOLDET_KEY_ADC_LVL2         (342-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (514-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (635-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL5         (784-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (790+VOLDET_KEY_ADC_RANGE)
