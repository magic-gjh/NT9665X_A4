...
#define GPIO_SENSOR_PWM0            P_GPIO_38
#define GPIO_SENSOR_PWM1            P_GPIO_39
...
#define GPIO_SENSOR2_DET         P_GPIO_51
#define PAD_SENSOR2_DET                  PAD_PIN_PGPIO51
