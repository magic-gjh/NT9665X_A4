...
#define LCDMODE                     DISPDEV_LCDMODE_MIPI
#elif (_LCDTYPE_ == _LCDTYPE_GL4300_)
#define LCDMODE                     DISPDEV_LCDMODE_CCIR656
#elif (_LCDTYPE_ == _LCDTYPE_CCIR601_)
#define LCDMODE                     DISPDEV_LCDMODE_CCIR601
#else
...
{
    DBG_IND("GPIOMap_TurnOnLCDBacklight: Adjust value %d,%d\r\n", g_LCDBacklightLvl,g_LCDBacklightEn);
...
{
    DBG_IND("GPIOMap_TurnOffLCDBacklight: Adjust value %d,%d\r\n", g_LCDBacklightLvl,g_LCDBacklightEn);
