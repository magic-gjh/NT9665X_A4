...
#if (_LCD2TYPE_ == _LCD2TYPE_T43P49_OTA5180A_)
...
// Local Variables
UINT32          g_LCD2Dout = 0; //current dout
...
//public func
UINT32 DrvLCD2Getcaps(UINT32 CapID, UINT32 Param1); // Get Capability Flag (Base on interface version)
UINT32 DrvLCD2Setcfgs(UINT32 CfgID, UINT32 Param1); // Set Config Setting
UINT32 DrvLCD2Init(void* pInitParam); // Set Init Parameters
UINT32 DrvLCD2Open(void); // Common Constructor
UINT32 DrvLCD2Close(void); // Common Destructor
UINT32 DrvLCD2State(UINT32 StateID, UINT32 Value); // General Properties
UINT32 DrvLCD2Control(UINT32 CtrlID, UINT32 Param1, UINT32 Param2);  // General Methods
UINT32 DrvLCD2Command(CHAR *pcCmdStr); //General Command Console

//internal func
void DrvLCD2_TurnOn(void);
void DrvLCD2_TurnOn_WaitFinish(void);
void DrvLCD2_TurnOff(void);
void DrvLCD2_Dump(void);
void DrvLCD2_SleepEnter(void);
void DrvLCD2_SleepLeave(void);

extern void     GPIOMap_TurnOnLCD2Backlight(void);
extern void     GPIOMap_TurnOffLCD2Backlight(void);
extern void     GPIOMap_SetLCD2BacklightBrightLevel(INT32 uiLevel);
extern void     GPIOMap_AdjustLCD2Backlight(UINT32 uiAdjValue);
extern BOOL     GPIOMap_IsLCD2BacklightOn(void);
extern void     GPIOMap_LCD2DumpBacklight(void);

extern void     GPIOMap_TurnOnLCD2Power(void);
extern void     GPIOMap_TurnOffLCD2Power(void);
extern void     GPIOMap_LCD2Reset(void);
extern BOOL     GPIOMap_IsLCD2PowerOn(void);
...
UINT32 hDevLCD2 = (UINT32)&gDevLCD2;

static void _DrvLCD2HookDout(UINT32 id)
{
    pObj = 0;
    if(id == 1)
...
UINT32 DrvLCD2Init(void* pInitParam) // Set Init Parameters
{
    ...
    g_LCDLastMode = DrvLCD2Getcaps(DISPLAY_CAPS_DEFMODE, 0);
...
//        pCtrl->SEL.SET_SRCCLK.SrcClk = DISPCTRL_SRCCLK_PLL1;
    ...
    {
    pad_setDrivingSink(PAD_DS_LGPIO12, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO13, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO14, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO15, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO16, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO17, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO18, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO19, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO20, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO21, PAD_DRIVINGSINK_7P5MA);
    pad_setDrivingSink(PAD_DS_LGPIO22, PAD_DRIVINGSINK_7P5MA);
    }
    ////////////////////////////////////////////////////

    GPIOMap_TurnOnLCD2Power();
    GPIOMap_LCD2Reset();
...
UINT32 DrvLCD2State(UINT32 StateID, UINT32 Value) // General Properties
{
    ...
    case DRVDISP_STATE_BACKLIGHT:
        rvalue =  GPIOMap_IsLCD2BacklightOn()?DRVDISP_BACKLIGHT_ON:DRVDISP_BACKLIGHT_OFF;
        break;
    ...
    case DRVDISP_STATE_BRIGHTLVL:
        {
            ...
            GPIOMap_SetLCD2BacklightBrightLevel((INT32)Value);
        }
        break;
    default:
        DBG_ERR("state=0x%02X not support!\r\n", StateID);
...
void DrvLCD2_Dump(void)
{
    GPIOMap_LCD2DumpBacklight();
}


////////////////////////////////////////////////////////////////////////////////
// GPIO related
void GPIOMap_LCD2Reset(void)
{
    // Reset LCD
...
/**
  ...
  @return void
*/
void GPIOMap_TurnOnLCD2Power(void)
{
}
...
/**
  ...
  @return void
*/
void GPIOMap_TurnOffLCD2Power(void)
{
...
/**
  ...
  @return BOOL
*/
BOOL GPIOMap_IsLCD2PowerOn(void)
{
    return TRUE;
}
...
/**
  ...
  @return void
*/
void GPIOMap_TurnOnLCD2Backlight(void)
{
    ...
    if (g_LCDBacklightEn == FALSE)
    {
        ...
        gpio_setPin(GPIO_LCD2_BLG_PCTL);
#endif
        g_LCDBacklightEn = TRUE;
    }
}

void GPIOMap_SetLCD2BacklightBrightLevel(INT32 uiLevel)
{
    ...
    GPIOMap_AdjustLCD2Backlight(g_LCDBacklightLvl);
}
...
/**
  ...
  @return void
*/
void GPIOMap_TurnOffLCD2Backlight(void)
{
...
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
        gpio_clearPin(GPIO_LCD2_BLG_PCTL);
#endif
...
/**
  ...
  @return void
*/
void GPIOMap_AdjustLCD2Backlight(UINT32 uiAdjValue)
{
...
/**
  ...
  @return BOOL
*/
BOOL GPIOMap_IsLCD2BacklightOn(void)
{
    return g_LCDBacklightEn;
}

void GPIOMap_LCD2DumpBacklight(void)
{
#if (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)
