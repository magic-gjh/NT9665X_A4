...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_MI5100_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_)
...
#elif (_LCDTYPE_ == _LCDTYPE_TXDT270C_8961_6A6_ || _LCDTYPE_ == _LCDTYPE_TXDT270C_8961_6A6_Flip_)
...
#if (_LCD2TYPE_ == _LCD2TYPE_AUCN01_)
                                PINMUX_DISPMUX_SEL_LCD2 | PINMUX_LCDMODE_YUV640 |
#elif (_LCD2TYPE_ == _LCD2TYPE_T43P49_OTA5180A_)
                                PINMUX_DISPMUX_SEL_LCD2 | PINMUX_LCDMODE_RGB_SERIAL |
#endif
                                0},
