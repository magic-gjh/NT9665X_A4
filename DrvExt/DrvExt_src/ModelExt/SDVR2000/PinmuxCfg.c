...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_SDIO2,            PIN_SDIO_CFG_8BITS|PIN_SDIO_CFG_2ND_PINMUX},
#else
    //{PIN_FUNC_SDIO2,            PIN_SDIO_CFG_4BITS|PIN_SDIO_CFG_1ST_PINMUX},
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_MI5100_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_|| _SENSORLIB_ == _SENSORLIB_CMOS_OV2710_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_ || _SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_)
...
#if (_GYRO_EXT_!=_GYRO_EXT_NONE_) //for GyroSensor
                                PIN_SPI_CFG_CH3 |
#endif
...
#endif
                                0},
    {PIN_FUNC_REMOTE,           PIN_REMOTE_CFG_CH1},
    ...
    {PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_NONE |
                                ...
                                PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_THROUGH |
